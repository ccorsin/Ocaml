let main () =
  ...
  let dalek = new Dalek.dalek  in
    ...
    print_endline ("Dalek To_string : " ^ (dalek#to_string)); print_endline "";
    print_endline "Fight !";
    people#talk ;
    doctor#talk;
    dalek#talk ;
    dalek#exterminate people ; print_endline (dalek#to_string) ;
    doctor#use_sonic_screwdriver ;
    dalek#talk ;
    dalek#die;
    doctor#travel_in_time 2000 1995 ; print_endline (doctor#to_string)
