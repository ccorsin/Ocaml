...
let main () =
  ...
  print_endline "Réaction équilibrée : "; 
  ...
  print_string "Liste des atomes start : " ; print_atom_list (r1#atoms_start) ; print_endline "" ;
  print_string "Liste des atomes result : " ; print_atom_list (r1#atoms_result) ; print_endline ""
